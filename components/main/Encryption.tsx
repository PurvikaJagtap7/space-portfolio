...
const Encryption = () => {
  return (
    <div className="flex flex-col sm:flex-row relative items-center justify-center min-h-screen w-full h-full">
      <div className="absolute w-auto h-auto top-0 z-[5] px-4 sm:px-0">
        <motion.div
      ...
      <div className="absolute z-[20] bottom-[10px] px-[5px] w-full text-center">
        <div className="cursive text-[16px] sm:text-[20px] font-medium text-gray-300">
